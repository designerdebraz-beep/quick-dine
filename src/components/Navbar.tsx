...
import { Menu, X, LogOut, LayoutDashboard, ShieldCheck, Plus } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center h-full px-6 md:px-10">
                ...
                <div className="flex items-center gap-12">
                    ...
                    <div className="hidden md:flex gap-8 items-center">
                        ...
                        <Link
                            to="/about"
                            className={`text-sm transition-colors pb-1 border-b-2 border-transparent cursor-pointer ${location.pathname === "/about" ? "text-secondary border-secondary" : scrolled || location.pathname !== "/" ? "text-black/55 hover:text-primary" : "text-white/80 hover:text-white"}`}
                        >
                            About
                        </Link>
                        <button
