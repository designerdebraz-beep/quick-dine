...
import { createRestaurantForm } from "../../lib/restaurants.js";
...
export default function RestaurantWizard({ setRestaurant }: RestaurantWizardProps) {
    ...
    const handleCreateRestaurant = async (e: React.FormEvent) => {
        ...
        try {
            ...
            else formData.append("image", "/restaurant_5.png");

            const restaurant = await createRestaurantForm(formData, token as string);
