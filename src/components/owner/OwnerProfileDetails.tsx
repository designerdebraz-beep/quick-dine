...
import { updateRestaurantForm } from "../../lib/restaurants.js";
...
export default function OwnerProfileDetails({ restaurant, setRestaurant }: OwnerProfileDetailsProps) {
    ...
    useEffect(() => {
        if (restaurant) {
            (() => {
                ...
                setImagePreview(imageUrl(restaurant.image) || "");
    ...
    const handleUpdateRestaurant = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const updated = await updateRestaurantForm(restaurant._id, formData, token as string);
