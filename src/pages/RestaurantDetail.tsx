...
import { getRestaurantBySlug } from "../lib/restaurants.js";
...
export default function RestaurantDetail() {
    ...
    useEffect(() => {
        const fetchRestaurant = async () => {
            try {
                const restaurant = await getRestaurantBySlug(slug as string);
    ...
    useEffect(() => {
        const fetchAvailability = async () => {
            const slots = (restaurant?.availableSlots || []).map((time: string) => ({
                time,
